...
public class BitwiseRightShiftInstruction extends TwoNumberOperatorInstruction {

    public BitwiseRightShiftInstruction(ScriptValueSupplier left, ScriptValueSupplier right) { super(left, right); }
    ...
    @Override public ScriptInstructionType type() { return OgdenScriptInstructionTypes.BITWISE_RIGHT_SHIFT; }

    public static class Serializer extends TwoNumberOperatorInstruction.Serializer {
        public Serializer() { super(BitwiseRightShiftInstruction::new); }
    }
