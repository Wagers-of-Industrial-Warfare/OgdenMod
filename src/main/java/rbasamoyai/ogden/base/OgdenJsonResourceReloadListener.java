 ...
 */
public abstract class OgdenJsonResourceReloadListener extends SimplePreparableReloadListener<Multimap<ResourceLocation, JsonElement>> {
	...
	public OgdenJsonResourceReloadListener(Gson gson, String directory) {
		this.gson = gson;
